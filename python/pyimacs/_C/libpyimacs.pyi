...
class Value:
    def set_attr(self, name: string, attr: "Attribute"): ...
...
class Module(OpState):
    ...
    def get_function(self, func_name: str) -> "FuncOp": ...
...
class Function(OpState):
    def args(self, idx: int) -> BlockArgument: ...
...
class Builder:
    ...
    # Create a return
    def ret(self) -> None: ...
    def call(self, func: Function, args: List[Value]) -> OpState: ...
    ...
    def restore_insertion_point(self) -> None: ...
    def get_bool_attr(self, v: bool) -> BoolAttr: ...
    def get_int32_attr(self, v: int) -> IntegerAttr: ...
    def get_int1(self, v: bool) -> Value: ...
    def get_int32(self, v: bool) -> Value: ...
    def get_string(self, v: bool) -> Value: ...
    def get_float32(self, v: bool) -> Value: ...
